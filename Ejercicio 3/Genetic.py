...
def mutate(matrix, mutation_rate=0.25, mutation_strength=0.02):
    #mutation_rate es la probabilidad de que ocurra una mutación
    #mutation_strength es la magnitud de la mutación
    """
